function [aux]=rhoNFW(s)
% Numerical aproximation of the function rho_0(s) defined in Proposition 1.1 considering the NFW model
%
% s is a row vector containing scale factors 
%
% rhoNFW(s) returns a row vector whose ith component is rho_0(s(i))
%
...
aux=0*s;
vHalos=vNFW(radii,s);
rhs= WeighProd(vHalos,vHalos,weights); % rhs Eqs 22 and 23 up to multiplicative constant 1/(s^3 CteDim) .
